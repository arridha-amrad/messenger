    ...
    return (
        <div
            ...
            className={`flex gap-4 cursor-pointer items-center hover:bg-blue-100 dark:hover:bg-indigo-700 py-1 px-2 mr-2 rounded-lg ${
                receiverId && receiverId === room.user.id ? 'dark:bg-indigo-700 bg-blue-100' : 'bg-transparent'
            } `}
        >
            <img
            ...
            <div className="flex flex-col w-18">
                <p className="self-start text-sm text-slate-400 dark:text-gray-100 text-end">{time}</p>
